	...
	return (
		<div className='h-full relative p-[54px] font-alfa flex flex-col gap-[20px]'>
			...
			<div className='w-full flex justify-center'>
				<div className='h-[161px] text-[20px] w-[500px] rounded-[20px] flex text-white p-5 bg-copper border-solid border-4 border-white'>
					{answer[index + 1]
						? `${answer[index + 1]}. ${
			...
			<div className='text-center text-pastelPink text-[20px]'>
				The answer is : {questions[index].options[questions[index].answer]}
			</div>
			<div className='absolute bottom-[60px] right-[54px] flex justify-end mx-[20px] gap-5 '>
				...
				<div
					...
					className='text-[36px] bg-copper flex items-center cursor-pointer  p-1 text-pastelPink border-solid border-[6px] border-pastelPink hover:border-white hover:scale-110 hover:shadow-2xl hover:text-white'>
					View Score
				</div>
			</div>
		</div>
